package com.example.hostelmanagementsystem.helper
...
import com.example.hostelmanagementsystem.activities.StudentActivity
...
class MyFirebaseMessagingService:FirebaseMessagingService() {
    ...
    private fun showNotification(
        ...
        val ii = Intent(context, StudentActivity::class.java)
        ...
        val deleteIntent = Intent(this, StudentActivity::class.java)
